...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/literature/insert.html" method="post">
		<div class="row cl">
		...
		<label class="form-label col-xs-4 col-sm-2 literature_add_Img">图片：</label>
			<div class="formControls col-xs-8 col-sm-9 literature_add_file"> 
		...
		<div class="row cl">
			...
			<div class="form-group" style="margin-left:300px;">
					...
					<input class="btn btn-primary literature_add_save" onclick="addActivity();" value="保存" type="button">
