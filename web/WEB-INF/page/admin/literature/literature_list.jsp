...
<body>
	<nav class="breadcrumb">
		...
		文献管理 <span class="c-gray en">&gt;</span> 文献列表 <a
	...
	<div class="page-container">
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			...
			<a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i>
					批量删除</a> 
			<a class="btn btn-primary radius" data-title="添加文献"
				href="${pageContext.request.contextPath}/admin/literature/insertjsp.html">
				<i class="Hui-iconfont">&#xe600;</i> 添加文献</a>
				<input type="text" value="${title}" id="aaa" name="selectTitle" placeholder="请输入文献标题"
			...
			<table
				...
				<tbody id="idData">
					<c:forEach items="${literaturelist}" var="literature">
						<tr class="text-c">
							<td><input type="checkbox" value="${literature.id}" name="id[]" onclick="check()"></td>
							<%-- <td>${literature.id}</td> --%>
							<td>${literature.title}</td>
							<td>${literature.author}</td>
							<td>${literature.sources}</td>
							<td><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${literature.time}"/></td>


							<td class="f-14 td-manage"><a style="text-decoration:none" class="ml-5"
								href="${pageContext.request.contextPath}/admin/literature/updateView.html?id=${literature.id}" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
								<a style="text-decoration: none" class="ml-5" onClick="activity_del(this,'${literature.id}')" href="javascript:;"
	...
	<form action="${pageContext.request.contextPath}/admin/literature/selectTitle.html" method="post" id="pageform"></form>
	...
	<script type="text/javascript"
		...
		<script type="text/javascript"
		src="${pageContext.request.contextPath}/static/admin/lib/literaturepaging.js"></script>
	<script type="text/javascript">
