...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/inform/insert.html" method="post">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="form-group" style="margin-left:300px;">
					...
					<input class="btn btn-primary inform_add_save" onclick="addActivity();" value="保存" type="button">
