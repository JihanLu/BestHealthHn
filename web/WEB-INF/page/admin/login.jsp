...
<![endif]-->
<script src="${pageContext.request.contextPath}/static/user/index/js/jquery.min.js"></script>
...
<link href="${pageContext.request.contextPath}/static/admin/static/h-ui.admin/css/H-ui.login.css" rel="stylesheet" type="text/css" />
    ...
    <form class="form form-horizontal" action="index.html" method="post">
      <div class="row cl">
        ...
        <div class="formControls col-xs-8">
          <input id="adminsName" name="" value="" type="text" placeholder="账户" class="input-text size-L">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">&#xe60e;</i></label>
        <div class="formControls col-xs-8">
          <input id="password" name="" value="" type="password" placeholder="密码" class="input-text size-L">
        </div>
      </div>
     <!--  <div class="row cl">
     ...
     <!--  <div class="row cl">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <input name="" type="button" id="denglu" class="btn btn-success radius size-L" value="&nbsp;登&nbsp;&nbsp;&nbsp;&nbsp;录&nbsp;">
...
<script type="text/javascript">
	$(function(){
		...
		$("#denglu").click(function(){
			 var login_val=$("#adminsName").val().trim();
	         var pass_val=$("#password").val().trim();
	            if(login_val==''){
	                layer.tips("用户名不能为空","#adminsName");
	                return false;
	            }
	            if(pass_val==''){
	            ...
	            $.ajax({
	    			...
	    			data:{"userName":login_val,"password":pass_val},
	    			dataType:"json",
	    			type:"post",
