...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/intro/intros.html" method="post">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 intro_col"> 
				...
				<textarea name="content" id="content">${intro.content}</textarea>
