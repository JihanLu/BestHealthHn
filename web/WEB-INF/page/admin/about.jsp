...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/about/abouts.html" method="post">
	
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2 about_col about_con">文章内容</label>
			<div class="formControls col-xs-8 col-sm-9 about_col about_textarea_main"> 
			...
			<div class="form-group" style="margin-left:300px;">
					...
					<input class="btn btn-primary about_add_save" onclick="addActivity();" value="保存" type="button">
