...
<body>
	...
	<div class="page-container">
		...
		<div class="mt-20">
			<table 
				...
				<tbody id="idData">
					<c:forEach items="${list}" var="replyOne" >
						<tr class="text-c">
							<td><input type="checkbox" value="${replyOne.replyOneID}" name="id[]" onclick="check()"></td>
						<%-- 	<td>${activity.id}</td> --%>
							...
							<td>
						<a href="${pageContext.request.contextPath}/admin/replyTow/list2.html?id=${replyOne.replyOneID}">回复详情</a>
							</td>
							...
							<td class="f-14 td-manage">
								<a style="text-decoration: none" class="ml-5" onClick="activity_del(this,'${replyOne.replyOneID}')" href="javascript:;"
	...
	<form action="${pageContext.request.contextPath}/admin/replyOne/list1.html" method="post" id="pageform"></form>
	...
	<script type="text/javascript"
		...
		<script type="text/javascript"
		src="${pageContext.request.contextPath}/static/admin/lib/luntanpaging2.js"></script>
	<script type="text/javascript">
