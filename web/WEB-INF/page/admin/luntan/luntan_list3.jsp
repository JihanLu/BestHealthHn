...
<body>
	...
	<div class="page-container">
		...
		<div class="mt-20">
			<table
				...
				<tbody id="idData">
					<c:forEach items="${list}" var="replyTow" >
						<tr class="text-c">
							<td><input type="checkbox" value="${replyTow.replyTowID}" name="id[]" onclick="check()"></td>
						<%-- 	<td>${activity.id}</td> --%>
							...
							<td class="f-14 td-manage">
								<a style="text-decoration: none" class="ml-5" onClick="activity_del(this,'${replyTow.replyTowID}')" href="javascript:;"
	...
	<form action="${pageContext.request.contextPath}/admin/replyTow/list2.html" method="post" id="pageform"></form>
	...
	<script type="text/javascript"
		...
		<script type="text/javascript"
		src="${pageContext.request.contextPath}/static/admin/lib/luntanpaging3.js"></script>
	<script type="text/javascript">
