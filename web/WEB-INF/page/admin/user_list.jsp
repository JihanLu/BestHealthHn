...
<body>
	...
	<div class="page-container">
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			...
			<%-- <a class="btn btn-primary radius" data-title="添加活动"
				...
				<input type="text" value="${title}" id="aaa" name="selectTitle" placeholder="请输入用户账号"
			...
			<table
				...
				<tbody id="idData">
					<c:forEach items="${userlist}" var="user">
						<tr class="text-c">
							<td><input type="checkbox" value="${user.userID}" name="id[]" onclick="check()"></td>
							<td><img src="${pageContext.request.contextPath}/picture/${user.headPhoto}" style="width: 60px;"></td>
							<td>${user.account}</td>
							<td>${user.name}</td>
							<td>${user.phone}</td>
							<td><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${user.time}"/></td>


							<td class="f-14 td-manage"> <a style="text-decoration:none" class="ml-5"
								href="${pageContext.request.contextPath}/admin/user/updateView.html?id=${user.userID}" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
								<a style="text-decoration: none" class="ml-5" onClick="activity_del(this,'${user.userID}')" href="javascript:;"
	...
	<form action="${pageContext.request.contextPath}/admin/user/selectTitle.html" method="post" id="pageform"></form>
...
<!-- 	<div class="tcdPageCode" id="tcdPageCode"></div> -->
	...
	<script type="text/javascript"
		...
		<script type="text/javascript"
		src="${pageContext.request.contextPath}/static/admin/lib/userpaging.js"></script>
	<script type="text/javascript">
