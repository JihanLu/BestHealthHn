...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/news/insert.html" method="post">
		<div class="row cl">
		...
		<label class="form-label col-xs-4 col-sm-2 news_add_Img">图片：</label>
			<div class="formControls col-xs-8 col-sm-9 news_add_file"> 
			<input type="file" name="image" id="photo">
				<!-- <textarea name="content" id="content"></textarea>
					<script type="text/javascript">CKEDITOR.replace('content');</script> -->
			</div>
		<label class="form-label col-xs-4 col-sm-2 news_add_Img">置顶：</label>
			<div class="formControls col-xs-8 col-sm-9 news_add_file"> 
			<select name="topid" id="topid" class="required"
					style="width: 7.5%; border: 2px solid #DCE1E9; height: 25px;">
					<option value="0">否</option>
					<option value="1">是</option></select><br>
			</div>
		<div class="row cl">
			...
			<div class="form-group news_add_sub" style="margin-left:300px;margin-top: 13px;">
			        <input class="btn btn-primary news_add_save" onclick="addActivity();" value="保存" type="button">
					<input class="btn btn-primary " id="reset" value="重置" type="button" >
