...
<body>
	...
	<div class="page-container">
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			...
			<a class="btn btn-primary radius" data-title="添加活动"
				...
				<input type="text" value="${title}" id="aaa" name="selectTitle" placeholder="请输入活动标题"
		...
		<div class="mt-20">
			<table
				...
				<tbody id="idData">
					<c:forEach items="${actitylist}" var="activity">
						<tr class="text-c">
							<td><input type="checkbox" value="${activity.id}" name="id[]" onclick="check()"></td>
						<%-- 	<td>${activity.id}</td> --%>
							<td>${activity.title}</td>
							<td>${activity.author}</td>
							<td>${activity.sources}</td>
							<td><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${activity.time}"/></td>


							<td class="f-14 td-manage"><a style="text-decoration:none" class="ml-5"
								href="${pageContext.request.contextPath}/admin/activity/updateView.html?id=${activity.id}" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
								<a style="text-decoration: none" class="ml-5" onClick="activity_del(this,'${activity.id}')" href="javascript:;"
	...
	<form action="${pageContext.request.contextPath}/admin/activity/selectTitle.html" method="post" id="pageform"></form>
	...
	<script type="text/javascript"
		...
		<script type="text/javascript"
		src="${pageContext.request.contextPath}/static/admin/lib/activitypaging.js"></script>
	<script type="text/javascript">
