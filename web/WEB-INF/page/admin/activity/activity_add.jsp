...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" enctype="multipart/form-data" action="${pageContext.request.contextPath}/admin/activity/insert.html" method="post">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="form-group news_add_sub" style="margin-left:300px;margin-top: 13px;">
					...
					<input class="btn btn-primary activity_add_save" onclick="addActivity();" value="保存" type="button">
