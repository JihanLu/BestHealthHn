...
<body class="abg">
    ...
    <table width="1002" height="57" class='pro_main' border="0" cellpadding="0" cellspacing="0" background="${pageContext.request.contextPath}/static/user/pro_Pro/images/dirs.gif">
      <tr>
        <td width="62">&nbsp;</td>
        <td width="701" valign="top" class="dir12" style="padding-top:12px;">您现在的位置：<a href="${pageContext.request.contextPath}/user/index/home.html">贝仕特首页</a>-&gt;<a href="${pageContext.request.contextPath}/user/recommend/recommends.html">项目产品推荐</a></td>
      </tr>
    </table>
      <table width="1002" height="62" border="0" cellpadding="0" cellspacing="0" background="${pageContext.request.contextPath}/static/user/pro_Pro/images/btoplbgg.gif" class='pro_main'>
        <tr>
          ...
          <td width="308" align="center" valign="top" class="h14b" style="padding-top:16px;">项目产品推荐</td>
          <td width="236">&nbsp;</td>
        </tr>
      </table>
      <table width="1002" border="0" cellpadding="0" cellspacing="0" background="${pageContext.request.contextPath}/static/user/pro_Pro/images/clbg.gif" class='pro_main'>
        <tr valign="top">
          ...
          <dl>
	          <dt>
		          <a href="${pageContext.request.contextPath}/user/recommend/recommendID.html?id=${list.id}" target="_blank" title="${list.title}" target="_blank">
		            <img src="${pageContext.request.contextPath}/picture/${list.photo }" width=203 height=122>
		          </a>
	          </dt>
	          <dd class='pro_Pro_sheng'>
	            <a href="${pageContext.request.contextPath}/user/recommend/recommendID.html?id=${list.id}" target="_blank" title="${list.title}" target="_blank" title="${list.title }">${list.title }</a>
	          </dd>
          </dl>
          </c:forEach>
...
if(countPage>1&&currentPage!=0&&currentPage!=1)
	document.write("<a href="+"${pageContext.request.contextPath}/user/recommend/recommends.html?PAGENOW="+ 1 +"\ title=\"首页\">"+imgIndex+"</a>&nbsp;<a href="+"${pageContext.request.contextPath}/user/recommend/recommends.html?PAGENOW="+ prevPage + "\ title=\"上一页\">"+imgPrev+"</a>&nbsp;");
else if(countPage>1&&currentPage!=0&&currentPage==1)
	document.write("<a href="+"${pageContext.request.contextPath}/user/recommend/recommends.html?PAGENOW="+imgIndex+"</a>&nbsp;<a href=\"#\">"+imgPrev+"</a>&nbsp;");
else
...
for(var i=0+(currentPage-1-(currentPage-1)%num) ; i<=(num+(currentPage-1-(currentPage-1)%num))&&(i<countPage) ; i++){
	if(i+1==1){
		document.write("<a href="+"${pageContext.request.contextPath}/user/recommend/recommends.html?PAGENOW="+ (i+1) +"\ title=\"\">"+(i+1)+"</a>&nbsp;"); 
...
if(countPage>0&&currentPage!=(countPage))
	document.write("<a href="+"${pageContext.request.contextPath}/user/recommend/recommends.html?PAGENOW="+ nextPage +"\ title=\"下一页\">"+imgNext+"</a>&nbsp;<a href="+"${pageContext.request.contextPath}/user/recommend/recommends.html?PAGENOW="+ countPage + "\ title=\"最后一页\">"+imgLast+"</a>&nbsp;");
else
