function selectTitle1(){
		  ...
		  if(title==""){
			  ...
			  window.location.href="/admin/inform/selectTitle.html?title="+title+"";
		  }
	}
//批量删除
 function datadel(){
	...
	for(k in boxes){
 	...
 	if (Checkbox){
 		 layer.confirm('您确认要删除选中的内容吗？', {
 		    ...
 		    $.ajax({
 		        url:"/admin/inform/delectAll.html",
 		        dataType: "json",
 		        type: "post",
 ...
 function article_edit(id){
 	window.location.href="/admin/inform/select.html?id="+id+"";
 }
