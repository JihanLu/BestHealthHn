function selectTitle1(){
		  ...
		  if(title==""){
			  ...
			  window.location.href="/admin/user/selectTitle.html?title="+title+"";
		  }
	}
//批量删除
 function datadel(){
 ...
 function article_edit(id){
 	window.location.href="/admin/user/select.html?id="+id+"";
 }
