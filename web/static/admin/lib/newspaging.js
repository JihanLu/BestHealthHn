function selectTitle1(){
		  ...
		  if(title==""){
			  ...
			  window.location.href="/admin/news/selectTitle.html?title="+title+"";
		  }
	}
//批量删除
 function datadel(){
 ...
 function article_edit(id){
 	window.location.href="/admin/news/select.html?id="+id+"";
 }
