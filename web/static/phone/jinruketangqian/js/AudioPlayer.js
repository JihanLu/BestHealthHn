	...
	jQuery.fn.extend({
		"initAudio" : function(){
			...
			this.append(
				...
				<div class="controls">\
					<div class="play_controls">\
						<a class="btn_previous"><img src="../yinpin/jinruketangqian/images/pre.png" style="width: 2em;height: 2em;"/></a>\
						<a class="btn_play"><img src="../yinpin/jinruketangqian/images/zan.png" style="width: 2em;height: 2em;"/></a>\
						<a class="btn_next"><img src="../yinpin/jinruketangqian/images/nex.png" style="width: 2em;height: 2em;"/></a>\
					</div>\
					<div class="time_line">\
			...
			$(".music_list").click(function(ev){
				...
				myAudio.play();
				//if(currentSrc==http://music.huoxing.com/upload/20121215/1355575227640_8200.mp3)
			...
			$(myAudio).bind("play",function(){
				$(".btn_play").html("<img src='../yinpin/jinruketangqian/images/bo.png' style='width: 2em;height: 2em;'/>");
				...
				//	alert("1");
				//}
				//if(currentSrcIndex==2){
				//	alert("2");
				//}
			});
			$(myAudio).bind("pause",function(){
				$(".btn_play").html("<img src='../yinpin/jinruketangqian/images/zan.png' style='width: 2em;height: 2em;'/>");
